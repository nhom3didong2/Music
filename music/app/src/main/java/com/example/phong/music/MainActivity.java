...
public class MainActivity extends AppCompatActivity {
    ...
    Uri uri;
    private ArrayList<File> listSongs = arrSongFile;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //truyền dữ liệu
        arrSongFile = new ArrayList<File>();
        Intent i = getIntent();
        if (i != null) {
            Bundle b = i.getExtras();
            arrSongFile = (ArrayList) b.getParcelableArrayList("listsongs");
        ...
        btnPrev.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (position > 0) {
                    ...
                    uri = Uri.parse(arrSongFile.get(arrSongFile.size() - 1).toString());
                    position = arrSongFile.size() - 1;
                    moveSong(uri);
                }
            }
        });
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (position < arrSongFile.size() - 1) {
                    ...
                    uri = Uri.parse(arrSongFile.get(0).toString());
                    position = 0;
                    moveSong(uri);
                }
            }
    ...
    // buid MediaPlayer
    private void buidMediaPlayer(Uri uriL) {
        mPlayler = MediaPlayer.create(this, uriL);
        mPlayler.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
            @Override
            public void onCompletion(MediaPlayer mediaPlayer) {
                flagPlay = false;
    ...
    private void playMusic() {
        if (!flagPlay) {
            ...
            //show name
            String txtitem_song = arrSongFile.get(position).getName();
